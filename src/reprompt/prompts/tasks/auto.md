...
- If the user asks for multiple independent outcomes, preserve them as separate deliverables
  instead of forcing them into one task shape.
- Do not mistake a request to explain code for authorization to edit it, or a request to
  plan work for authorization to implement it.
