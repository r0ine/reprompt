...
TOPICS = {
    ...
    "ru": [
        ...
        "potok OAuth",
        "autentifikacija JWT",
        "rolevoj kontrol dostupa",
        "REST API",
        "skhema GraphQL",
        "obrabotchik webhookov",
        "upravlenie sostojaniem",
        "obrabotka oshibok",
        "lenivaja zagruzka",
        "generacija PDF",
        "eksport Excel",
    ...
    "zh": [
        ...
        "OAuth liucheng",
        "JWT renzheng",
        "jiyu jiaose de fangwen kongzhi",
        "REST API",
        "GraphQL jiagou",
        "webhook chuliqì",
    ],
    "ko": [
        ...
        "sangtae hwanin",
        "roging",
        "deiteobiseu maigeuresyeon",
        "yunit teseuteu",
        "tonghap teseuteu",
        "CI/CD paipeurain",
        "Docker seoljeong",
        "yeog-banghyang peuloksi",
        "OAuth heuleum",
        "JWT injeung",
        "yeokhal giban jeopgeun jegeo",
        "REST API",
        "GraphQL seukima",
        "webhook haendeuleo",
    ],
...
RAW_TEMPLATES = {
    "tr": [
        ...
        "{topic} temizle",
        "{topic} basitlestir",
        "{topic} guvenli hale getir",
        "{topic} icin dokuman yaz",
        "bi {topic} gerekiyor acil",
        "{topic} nasil yapilir",
    ...
    "en": [
        ...
        "simplify {topic}",
        "secure {topic}",
        "write docs for {topic}",
        "need {topic} asap",
        "how to do {topic}",
        "{topic} throws errors",
        "{topic} code is messy",
        "quickly set up {topic}",
        "integrate {topic}",
        "deploy {topic}",
        "review {topic}",
        "debug {topic}",
        "write {topic} from scratch",
        "design {topic}",
        "plan {topic}",
        "connect {topic}",
        "give example of {topic}",
    ],
    "de": [
        "{topic} erstellen",
        "{topic} hinzufuegen",
        ...
        "{topic} bauen",
        "ich brauche {topic}",
        "{topic} funktioniert nicht",
        "{topic} ist abgestuerzt",
        "{topic} ist zu langsam",
        "{topic} optimieren",
        "{topic} umstrukturieren",
        "{topic} ist fehlerhaft",
        "Tests fuer {topic} schreiben",
        "{topic} entfernen",
        "{topic} aktualisieren",
        "{topic} bereinigen",
        "{topic} vereinfachen",
        "{topic} absichern",
        "Doku fuer {topic} schreiben",
        "brauche {topic} dringend",
        "wie macht man {topic}",
        "{topic} wirft Fehler",
        "{topic} Code ist chaotisch",
        "{topic} schnell einrichten",
        "{topic} integrieren",
        "{topic} deployen",
        "{topic} ueberpruefen",
        "{topic} debuggen",
        "{topic} von Grund auf schreiben",
        "{topic} entwerfen",
        "{topic} planen",
    ],
    "fr": [
        ...
        "corriger {topic}",
        "construire {topic}",
        "j'ai besoin de {topic}",
        "{topic} ne fonctionne pas",
        "{topic} a plante",
        "{topic} est trop lent",
        "optimiser {topic}",
        "refactoriser {topic}",
        "{topic} est buggue",
        "ecrire des tests pour {topic}",
        "supprimer {topic}",
        "mettre a jour {topic}",
        "nettoyer {topic}",
        "simplifier {topic}",
        "securiser {topic}",
        "ecrire la doc pour {topic}",
        "besoin de {topic} urgent",
        "comment faire {topic}",
        "{topic} lance des erreurs",
        "le code de {topic} est sale",
        "configurer {topic} rapidement",
        "integrer {topic}",
        "deployer {topic}",
        "verifier {topic}",
        "debugger {topic}",
        "ecrire {topic} de zero",
        "concevoir {topic}",
        "planifier {topic}",
    ],
    "es": [
        ...
        "refactorizar {topic}",
        "{topic} tiene errores",
        "escribir tests para {topic}",
        "eliminar {topic}",
        "actualizar {topic}",
        "limpiar {topic}",
        "simplificar {topic}",
        "asegurar {topic}",
        "escribir docs para {topic}",
        "necesito {topic} urgente",
        "como hacer {topic}",
        "{topic} lanza errores",
        "el codigo de {topic} es un desastre",
        "configurar {topic} rapido",
        "integrar {topic}",
        "desplegar {topic}",
        "revisar {topic}",
        "depurar {topic}",
        "escribir {topic} desde cero",
        "disenar {topic}",
        "planificar {topic}",
    ],
    "pt": [
        ...
        "{topic} nao funciona",
        "{topic} travou",
        "{topic} esta muito lento",
        "otimizar {topic}",
        "refatorar {topic}",
        "{topic} esta com bug",
        "escrever testes para {topic}",
        "remover {topic}",
        "atualizar {topic}",
        "limpar {topic}",
        "simplificar {topic}",
        "proteger {topic}",
        "escrever docs para {topic}",
        "preciso de {topic} urgente",
        "como fazer {topic}",
        "{topic} da erro",
        "o codigo do {topic} esta bagunçado",
        "configurar {topic} rapido",
        "integrar {topic}",
        "fazer deploy de {topic}",
        "revisar {topic}",
        "debugar {topic}",
        "escrever {topic} do zero",
        "projetar {topic}",
        "planejar {topic}",
    ],
    "ru": [
        ...
        "{topic} ne rabotaet",
        "{topic} slomalsja",
        "{topic} slishkom medlennyj",
        "optimiziruj {topic}",
        "refaktoriruj {topic}",
        "{topic} gljuchit",
        "napishi testy dlja {topic}",
        "uberi {topic}",
        "obnovi {topic}",
        "pochisty {topic}",
        "uprosti {topic}",
        "obezopas {topic}",
        "napishi doku dlja {topic}",
        "nuzhno {topic} srochno",
        "kak sdelat {topic}",
        "{topic} vydaet oshibki",
        "kod {topic} uzhasen",
        "bystro nastroy {topic}",
        "integriruj {topic}",
        "zadeloj {topic}",
        "prover {topic}",
        "otladj {topic}",
        "napishi {topic} s nulja",
        "sprojektiruj {topic}",
        "splaniruj {topic}",
    ],
    "ja": [
        "{topic} wo tsukutte",
        "{topic} wo tsuika shite",
        "{topic} wo naoshite",
        "{topic} wo sakusei shite",
        "{topic} ga hitsuyou",
        "{topic} ga ugokimasen",
        "{topic} ga kurasshu shita",
        "{topic} ga osoi",
        "{topic} wo saitekika shite",
        "{topic} wo rifakutaringu shite",
        "{topic} ni bagu ga aru",
        "{topic} no tesuto wo kaite",
        "{topic} wo sakujo shite",
        "{topic} wo kooshin shite",
        "{topic} wo seiri shite",
        "{topic} wo kantan ni shite",
        "{topic} wo anzen ni shite",
        "{topic} no doku wo kaite",
        "{topic} ga kyuuyo hitsuyou",
        "{topic} no yarikata",
        "{topic} ga eraa wo dasu",
        "{topic} no koodo ga kitanai",
        "{topic} wo sassoku settoappu shite",
        "{topic} wo tougou shite",
        "{topic} wo deburoi shite",
        "{topic} wo rebyu shite",
        "{topic} wo debaggu shite",
        "{topic} wo zero kara kaite",
        "{topic} wo sekkei shite",
    ],
    "zh": [
        "zuo {topic}",
        "tianjia {topic}",
    ...
    "ko": [
        ...
        "{topic} gochigi",
        "{topic} saengseong",
        "{topic} ga pilyohabnida",
        "{topic} i jakdonghaji anseumnida",
        "{topic} i chungdol haesseumnida",
        "{topic} i neomu neurimnida",
        "{topic} choejeoghwa",
        "{topic} ripaektoring",
        "{topic} e beogeu isseoyo",
        "{topic} teseuteu jakseonghagi",
        "{topic} sakje",
        "{topic} eobdeiteu",
        "{topic} jeongri",
        "{topic} dansunh wa",
        "{topic} boanhwa",
        "{topic} munseo jakseonghagi",
        "{topic} geubhi pilyohabnida",
        "{topic} eotteoke hanaayo",
        "{topic} eleo balsaeng",
        "{topic} kodeu eojileowoyo",
        "{topic} ppalli seoljeong",
        "{topic} tonghap",
        "{topic} baepho",
        "{topic} geomto",
        "{topic} dibeogeu",
        "{topic} cheobuuteo jakseonghagi",
        "{topic} seolgye",
        "{topic} gyehoek",
    ],
}
